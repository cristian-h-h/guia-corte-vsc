...
const handleCheckout = async () => {
  ...
  if (isOrderPlaced) {
    return (
      <>
        <Helmet>
          <title>Pedido confirmado | GuiaDeCorte.cl</title>
          <meta
            name="description"
            content="Estado privado del pedido realizado para la guia de corte ProFix 126."
          />
          <meta name="robots" content="noindex, nofollow" />
          <link rel="canonical" href="https://www.guiadecorte.cl/carrito" />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>Carrito de compras | GuiaDeCorte.cl</title>
        <meta
          name="description"
          content="Area privada de carrito para preparar tu compra de la guia de corte ProFix 126."
        />
        <meta name="robots" content="noindex, nofollow" />
        <link rel="canonical" href="https://www.guiadecorte.cl/carrito" />
      </Helmet>
