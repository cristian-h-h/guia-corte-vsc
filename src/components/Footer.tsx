      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-naranja-500" />
                <a href={`tel:${phoneNumber}`} className="text-gris-300 hover:text-naranja-500 transition-colors">
                  {formattedPhone}
                </a>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gris-800 mt-8 pt-6 text-center">
          <p className="text-sm text-gris-400">
            &copy; <Link to="/admin" className="hover:text-naranja-500 transition-colors">{currentYear}</Link> GuiaDeCorte.cl - Todos los derechos reservados
          </p>
        </div>
      </div>
    </footer>
