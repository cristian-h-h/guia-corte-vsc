-- Insertar artículos de blog con contenido en formato JSON
...
VALUES (
  ...
  '{"type": "doc", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Contenido del artículo sobre cómo lograr cortes perfectos con la guía ProFix 126."}]}]}',
...
VALUES (
  ...
  '{"type": "doc", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Contenido del artículo sobre 5 proyectos de carpintería para principiantes con guía de corte."}]}]}',
...
VALUES (
  ...
  '{"type": "doc", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Contenido del artículo sobre mantenimiento de herramientas de carpintería."}]}]}',
